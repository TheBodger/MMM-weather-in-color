...
WeatherProvider.register("ukmetoffice_incolor", {
	...
	convertweathertypetoclass(weatherType, temperatureinc, windspeedinmph) {
		...
		const weatherclasses = {
			 ...
			 1: { exception_wind: '',		exception_cold: 'true', colorcloudbase: '', colormain: 'sun/frosty', colorday: '/sunny' },
			 2: { exception_wind: '',		exception_cold: '', colorcloudbase: '', colormain: '', colorday: '' },
			 3: { exception_wind: '',		exception_cold: 'true', colorcloudbase: 'cloud/basecloud', colormain: '/frosty', colorday: 'sunny' },
